// Negative-control entrypoint for the wake eval. A separate file, rather than a
...
// triggering condition removed (see EVAL_NEGATIVE_CONTROL in harness-wake.ts).
